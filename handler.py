...
def face_recognition_handler(event, context):
	...
	print(type(event))
	print(event)
	# key = event['Records'][0]['s3']['object']['key'] # uncomment this for project 2
	key = event['key1']['Records'][0]['s3']['object']['key'] # use this for project 3. 'key1' is the outermost key. Lambda trigger code packs it that way. 
